...
| **store review waiting** | APP_STORE_PLAY_STORE_PREP, store-review-test-accounts.md |
...
**Rule:** Finish baseline Items 2–5 before Layer 1 consolidator drives contract changes — otherwise reviews fight validated v1 behavior.
