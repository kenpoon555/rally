...
- [ ] **Screenshots** — required sizes per store; use same device class sets (e.g. 6.7" iPhone, Pixel profile).
...
- [ ] **Review notes** — test account credentials for reviewers; explain location usage briefly.
