...
print("Builder local ready — validate on this branch BEFORE src PR")
print("Run: ./.cursor/hooks/validation-loop-start.sh --queue cps-onboarding --from flow-age-gate-onboarding --builder")
PY
