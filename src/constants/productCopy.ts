...
export const PRODUCT_COPY = {
  ...
  joinStatusJoinedHint: 'Confirm so the host can lock the roster.',
  findNextGame: 'Find your next game',
  postGamePlayerTitle: 'Nice run!',
  postGamePlayerBody: 'That game is done. Keep the momentum going — jump into another one near you.',
